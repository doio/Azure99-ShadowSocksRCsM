...
namespace Shadowsocks.View
{
    public class MenuViewController
    {
        ...
        {
            Process.Start("https://github.com/Azure99/SsrBackup/wiki");
        }
        ...
        {
            controller.UpdatePACFromOnlinePac("https://raw.githubusercontent.com/Azure99/SsrBackup/master/breakwa11.github.io/ssr/ss_lanip.pac");
        }

        private void UpdatePACFromCNWhiteListItem_Click(object sender, EventArgs e)
        {
            controller.UpdatePACFromOnlinePac("https://raw.githubusercontent.com/Azure99/SsrBackup/master/breakwa11.github.io/ssr/ss_white.pac");
        }

        private void UpdatePACFromCNOnlyListItem_Click(object sender, EventArgs e)
        {
            controller.UpdatePACFromOnlinePac("https://raw.githubusercontent.com/Azure99/SsrBackup/master/breakwa11.github.io/ssr/ss_white_r.pac");
        }

        private void UpdatePACFromCNIPListItem_Click(object sender, EventArgs e)
        {
            controller.UpdatePACFromOnlinePac("https://raw.githubusercontent.com/Azure99/SsrBackup/master/breakwa11.github.io/ssr/ss_cnip.pac");
        }
        ...
        private void TestNetworkConnection_Click(object sender, EventArgs e)
        {
            using (WebClient wc = new WebClient())
            {
                try
                {
                    ...
                    proxy.Address = new Uri("http://127.0.0.1:" + controller.GetConfiguration().localPort);

                    wc.Proxy = proxy;
                    wc.Encoding = Encoding.UTF8;
                    string ipData = wc.DownloadString("http://archive.apnic.net/templates/ipv6man/");
                    string ipAddress = ipData.Substring(ipData.IndexOf("var ipaddress = '") + 17, ipData.IndexOf("';") - ipData.IndexOf("var ipaddress = '") - 17);
                    string[] ipArr = ipAddress.Split('.');
                    if (ipArr.Length == 4)
                    {
                        ShowBalloonTip(I18N.GetString("NetworkStatus"), I18N.GetString("OK! IP address:") + ipAddress, ToolTipIcon.Info, 10000);
                    }
                    return;
                }
                catch { }
